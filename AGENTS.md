...
Stack: TypeScript 6.x, Vite 7, Tailwind v4, Signals, Biome.
UI/UX: Spatial Glass, Bento Grids.
CI/CD: GitHub Actions (Parallel, Matrix).
Testing: Vitest, Playwright, Coverage (95%+).
State: Signals (Preact/Solid). NO Redux/Context.
Styling: Tailwind v4. NO CSS-in-JS.
Lint/Format: Biome. NO ESLint/Prettier.
Package Manager: pnpm. NO npm/yarn.
Build: Vite 7.
Spec Adherence: Full AGENTS.md compliance.
